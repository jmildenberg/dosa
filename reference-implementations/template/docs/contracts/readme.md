...
The authoritative OpenAPI and AsyncAPI specifications for what this domain publishes
(see [ADR-0013](../../../../docs/adrs/0013-openapi-and-asyncapi-for-contract-authoring.md)). These specs
are authored *first* — code in [modules/contracts/](../../modules/contracts/readme.md) is generated from
or verified against them, never the reverse.
