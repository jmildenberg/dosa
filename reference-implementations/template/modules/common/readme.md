...
behavior belongs in [Domain](../domain/readme.md) or [Application](../application/readme.md) instead, not
here. If a type in Common starts encoding a business rule, that is a sign it has outgrown this module.
