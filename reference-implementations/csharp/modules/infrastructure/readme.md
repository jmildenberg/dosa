...
**Depends on:** [Application](../application/readme.md), [Domain](../domain/readme.md), and
[Contracts/messaging](../contracts/messaging/readme.md) — the event types its messaging adapters
produce and consume. **Depended on by:** the in-process Hosts (`hosts/api`, `hosts/worker`), which wire
