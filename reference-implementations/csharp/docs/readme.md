...
|---|---|
| [architecture/](architecture/readme.md) | Why this domain's internal structure looks the way it does |
| [operations/](operations/readme.md) | How to run and support this domain at run time |
